...
function generateTimetable() {
  ...
  schedule.forEach((entry, index) => {
    ...
    addCell.appendChild(addRowButton);
...
// Function to remove a row from the timetable
function removeRow(index) {
  schedule.splice(index, 1); // Remove the entry from the schedule
  generateTimetable(); // Regenerate the timetable
}
